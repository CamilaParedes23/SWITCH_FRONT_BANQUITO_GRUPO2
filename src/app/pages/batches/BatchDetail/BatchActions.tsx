...
export function BatchActions({ estado, onValidate, onProcess, onLiquidate, onAnnul }: BatchActionsProps) {
  return (
    <div className="bg-[#F8FAFC] border border-gray-200 rounded-xl p-6">
      ...
      <div className="flex flex-wrap gap-4">
        {(estado === 'RECIBIDO' || estado === 'ENCOLADO') && (
          <button
            onClick={onValidate}
        ...
        {['PROCESADO_TOTAL', 'PROCESADO_PARCIAL'].includes(estado || '') && (
          <button
            onClick={onLiquidate}
        ...
        {['RECIBIDO', 'VALIDADO', 'ENCOLADO', 'VALIDANDO', 'RECHAZADO'].includes(estado || '') && (
          <button
            onClick={onAnnul}
